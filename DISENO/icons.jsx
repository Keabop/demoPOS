// SVG icon set — lucide-style strokes
const Icon = ({ name, size = 18, color = 'currentColor', strokeWidth = 2, style }) => {
  ...
  switch (name) {
    case 'leaf':
      return <svg {...props}><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96c.4 2.5.59 5 .5 7.5C19.45 16.5 16 20 11 20Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/></svg>;
    case 'home':
    ...
    case 'credit':
      return <svg {...props}><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>;
    case 'report':
    ...
    case 'barcode':
      return <svg {...props}><path d="M3 5v14"/><path d="M8 5v14"/><path d="M12 5v14"/><path d="M17 5v14"/><path d="M21 5v14"/></svg>;
    case 'plus':
    ...
    case 'arrow-up':
      return <svg {...props}><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></svg>;
    case 'arrow-down':
      return <svg {...props}><path d="M12 5v14"/><path d="m19 12-7 7-7-7"/></svg>;
    case 'arrow-right':
    ...
    case 'alert':
      return <svg {...props}><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12" y1="17" y2="17.01"/></svg>;
    case 'calendar':
      return <svg {...props}><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/></svg>;
    case 'clock':
    ...
    case 'printer':
      return <svg {...props}><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect width="12" height="8" x="6" y="14"/></svg>;
    case 'cash':
    ...
    case 'sack':
      return <svg {...props}><path d="M8 2h8l-2 3H10z"/><path d="M5 14c0-3 2-7 4-9h6c2 2 4 6 4 9 0 4-3 8-7 8s-7-4-7-8Z"/></svg>;
    case 'chevron-right':
